...
__qo_hw_rendering_init(
    ...
    _fn_eglGetPlatformDisplayEXT eglGetPlatformDisplayEXT = (void *)eglGetProcAddress("eglGetPlatformDisplayEXT");
    if (!eglGetPlatformDisplayEXT) 
    {
        QO_ERRPRINTF("Failed to get eglGetPlatformDisplayEXT\n");
        return QO_NOT_SUPPORTED;
    }
